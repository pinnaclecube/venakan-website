            ...
            <Reveal delay={60} from="right" variant="card">
              <div className="flex flex-col gap-12">
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="glass p-5 rounded-lg border-l-2 border-l-brand-blue">
                      <p className="text-sm"><strong>Quick inquiry?</strong> 24hr response.</p>
                    </div>
                    <div className="glass p-5 rounded-lg border-l-2 border-l-brand-violet">
                      <p className="text-sm"><strong>Complex engagement?</strong> We'll schedule a 30-min scoping call.</p>
                    </div>
                    <div className="glass p-5 rounded-lg border-l-2 border-l-cyan">
                      <p className="text-sm"><strong>Partnership?</strong> Let's talk about co-development.</p>
                    </div>
                  </div>
                </div>
              </div>
